...
const ExerciseCard = ({ exercise, current_sub_category }) => {
            ...
            questions: [
              {
                ...
                solution: [
                  'Hint: Multiplicera parenteserna'
                ],
                _id: '60e0a78cc4528b275d82f34f',
                correct_answer: 3
              }
            ],
            __v: 0,
    ...
    // const { category, sub_category, exercise_id, img_src, description, questions } = exercises[0];
